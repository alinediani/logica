...
var opcao=rs.question('Aperte A para adicionar,I para somente exibir e S para sair: ')
while(opcao!='S'){
if(opcao=='A'){
...
opcao=rs.question('Aperte A para adicionar,I para somente exibir e S para sair: ')
}